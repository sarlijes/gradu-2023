...
\title{Systemaattinen kirjallisuuskatsaus ohjelmistokehitysalan perehdytyskäytännöistä (v. 0.4.2)}
...
\relax.
%.
Olemassaolevan lähdekoodin suuri määrä, sen kompleksisuus ja siinä navigoiminen aiheuttavat myös pulmia tulokkaille %
\parencites%
    {britto-ym-2019}%
    {craig-ym-2018}
    {begel-simon-2008}%
...
Perehtyminen aiheuttaa tulokkaille myös kognitiivista kuormitusta usein eri tavoin. Heidän on vaikea tunnistaa, milloin he ovat jääneet jumiin, eivätkä pysty jatkamaan tehtäväänsä ilman apua \parencite{begel-simon-2008}. Muistiinpanojen ja muiden dokumenttien laatiminen ja organisointi on myös haastavaa %
\parencites%
    {radermacher-ym-2015}%
    {begel-simon-2008}%
\relax.
...
Työtehtäviin orientoitumista voi vaikeuttaa vähäinen tai heikko dokumentaatio, massiivinen olemassaolevan lähdekoodin määrä ja jopa se, ettei uusi työntekijä tunne työryhmänsä jäseniä lainkaan \parencite{begel-simon-2008}. He kuvaavat esimerkiksi tilannetta, jossa eräs vasta-alkaja käytti paljon aikaa lukemalla yrityksen sisäisiä asiakirjoja etsiessään tietoa siitä, mitä hänen työryhmässään oikeastaan edes tehdään. Myös \textcite{britto-ym-2019} ja \textcite{ju-ym-2021} toteavat dokumentaation puutteiden vaikeuttavan tulokkaiden työskentelyä.
...
\section{Perustelut teorioiden valitsemiselle}

\textit{Ohjaajan kommentti: "perustelut org.sos ja sos.resurssien teorian valitsemiselle tulisi mainita. Ovatko ne esim. yleisesti tutkimusalueella käytettyjä teorioita/viitekehyksiä (viitteet tarvitaan) tai onko niillä jokin selkeä yhteys perehdytykseen empiirisessä mielessä? Vastaavasti voisi kysyä että mistä tiedät että ko. teoreettinen viitekehys on sopiva tähän tutkimukseen? Tätä pitäisi pohtia viimeistään rajoitteissa luvussa 5.2."}

KESKEN!

TODO MOE ym: täällä esitelty Bayerin onboarding model, joka taitaa olla jossain muussakin käytetty? Mutta se jakaa perehdyttämisen kuuteen aktiviteettiin. Eli SRT-teoria on hienosyisempi, kun siinä on enemmän ulottuvuuksia ja myös ajallinen jatkumo huomioitu. 

Van Maanen ja Schein (1979) esittivät uraauurtavassa artikkelissaan, että on olemassa kuusi sosiaalistamistaktiikan luokkaa, joita organisaatiot, ensisijaisesti johtajien kautta, käyttävät vaikuttaakseen uuden työntekijän työhönottoon.  Kollektiiviset taktiikat opastavat tulokkaiden kohortteja organisaation tavoissa, kun taas yksilölliset taktiikat antavat tulokkaalle mahdollisuuden oppia yksin. Organisaatiot käyttävät virallisia oppimismahdollisuuksia , kuten koulutusseminaareja, tarvittavien työtaitojen opettamiseen, kun taas epäviralliset taktiikat jättävät tulokkaan opettelemaan nämä taidot työpaikalla. Peräkkäiset taktiikat paljastavat uusille tulokkaille ennalta määritellyn vaiheittaisen järjestyksen, joka auttaa heitä saavuttamaan pätevyyden, kun taas satunnaiset taktiikat jättävät tulokkaan tietämättömäksi tarvittavista vaiheista. Kiinteät taktiikat asettavat työntekijät selkeään perehdyttämisaikatauluun , kun taas vaihtelevien taktiikoiden käyttö tarkoittaa, että uudet työntekijät voivat perehtyä työhön omassa tahdissaan. Sarjamuotoista taktiikkaa käytetään silloin, kun uusi työntekijä täyttää roolin, jota muut ovat hoitaneet (ja voivat opettaa), kun taas työntekijät, jotka tekevät työnsä itse, käyttävät epäjohdonmukaista taktiikkaa.Jos organisaatio rakentaa uuden työntekijän aiempien taitojen varaan, se käyttää investointitaktiikkaa , kun taas jos uuden työntekijän on opittava taidot tyhjästä, se käyttää divestitointitaktiikkaa . Näiden taktiikoiden vaikutukset vaikuttavat useisiin lopputuloksiin, kuten uuden työntekijän suorituskykyyn, työtyytyväisyyteen, rooliristiriitoihin ja -epämääräisyyteen, organisaatioon sitoutumiseen ja irtisanoutumisaikeisiin . Peräkkäiset taktiikat paljastavat uusille tulokkaille ennalta määritellyn vaiheittaisen järjestyksen, joka auttaa heitä saavuttamaan pätevyyden, kun taas satunnaiset taktiikat jättävät tulokkaan tietämättömäksi tarvittavista vaiheista. Kiinteät taktiikat asettavat työntekijät selkeään perehdyttämisaikatauluun, kun taas vaihtelevien taktiikoiden käyttö tarkoittaa, että uudet työntekijät voivat perehtyä työhön omassa tahdissaan. Sarjamuotoista taktiikkaa käytetään silloin, kun uusi työntekijä täyttää roolin, jota muut ovat hoitaneet (ja voivat opettaa), kun taas työntekijät, jotka tekevät työnsä itse, käyttävät epäjohdonmukaista taktiikkaa.Jos organisaatio rakentaa uuden työntekijän aiempien taitojen varaan, se käyttää investointitaktiikkaa, kun taas jos uuden työntekijän on opittava taidot tyhjästä, se käyttää divestitointitaktiikkaa. Näiden taktiikoiden vaikutukset vaikuttavat useisiin lopputuloksiin, kuten uuden työntekijän suorituskykyyn, työtyytyväisyyteen, rooliristiriitoihin ja -epämääräisyyteen, organisaatioon sitoutumiseen ja irtisanoutumisaikeisiin.  

Van Maanen J, Schein EH (1979) Toward a theory of organizational socialization. Res Organ Behav 1:209–26
...
Perehdytyksen onnistuneisuutta oli mitattu vain harvoissa artikkeleissa, joten tässä katsauksessa mittareista ei juuri saatu tietoa. \textcite{britto-ym-2020} mittasivat globaalisti hajautettujen ohjelmistokehitystiimien tuottavuutta ja autonomiaa. Heidän tutkimuksessaan Intiassa toimivat ohjelmistokehittäjät tekivät ison, monimutkaisen, paljolti nk. legacy-koodista koostuvan tietojärjestelmän räätälöintityötä. Jokaisen työtehtävän kompleksisuus ja koko arvioitiin, jotta pystyttiin mittaamaan tiimien suoriutumista määrällisesti. Arviointiin osallistuivat myös kokeneet sovellusarkkitehdit. \textcite{britto-ym-2020} kertovat, että saatujen tulosten mukaan tulokkaiden suorituskyky kasvoi hitaasti. Kahden vuoden jälkeen he olivat edelleen keskimäärin 3,57 kertaa vähemmän tuottavia ja 1,67 kertaa vähemmän itsenäisiä kuin tavoitteeksi asetetut vertailuryhmät. He toteavat, että suorituskyky lienee tavoitetasolla aikaisintaan kolmen vuoden kuluessa, mutta siihen voi kulua jopa viisi vuotta.

Katsauksen ulkopuolisen kirjallisuuden perusteella \parencite{casalnuovo-ym-2015} voidaan todeta, että vahvat kehittäjien väliset sosiaaliset suhteet edistävät tulokkaiden tuottavuuden kasvamista. \textcite{britto-ym-2017} toteavatkin, että heidän tutkimansa yritykset olivat pyrkineet vahvistamaan sosiaalisia suhteita lisäämällä videoneuvotteluita ja kasvokkaisia tapaamisia. 

\textcite{moe-ym-2020} vertailivat taas sitä, missä määrin perehdytyksen eri osa-alueet %
\parencite%
    [][mukaan]{bauer-2010}%
\relax
eli rekrytointi, orientaatio, tukityökalut ja -prosessit, palautetyökalut, koulutus sekä valmennus ja tuki tulivat katetuiksi perehdytyksen aikana kahdessa eri ohjelmistokehitystiimissä. \textcite{moe-ym-2020} kertovat erojen olleen pieniä ja johtuneen lähinnä siitä, että mentorointia toteutettiin tiimeissä eri tavoilla, sillä toisessa tiimissä osa mentoreista joutui lopettamaan mentoroinnin kokonaan. 

\textcite{shannon-pool-2016} kertovat, että yhtenäisenä ryhmänä yrityksen omassa akatemiassa aloittaneiden tulokkaiden työpanos oli myönteinen jo kuuden viikon jälkeen. Tässä tutkimuksessa oli käytetty kymmentä eri perehdytyskäytäntöä. Tulokkaat toimivat vertaisryhmänä ja heille järjestettiin yhteinen muodollinen koulutusjakso. Sosiaaliset tapahtumat auttoivat vahvistamaan sosiaalisia suhteita. Mentoroinnin myötä tulokkaat saivat tukea. Akatemia kesti yhteensä kuusi kuukautta ja se sisälsi sekä luokkahuoneessa tapahtuvaa opetusta että käytännön harjoituksia. Tulokkaat liittyivät koulutusjaksonsa jälkeen ohjelmistokehitystiimeihin, joiden työskentely kyllä hidastuu ensimmäisten aluksi aikana, mutta palaa sitten tiimin aiempaan tahtiin. Tulokkaat tuovat lisäarvoa jo varhaisessa vaiheessa, mutta erityisesti 4 kuukauden jälkeen. \parencite{shannon-pool-2016}
