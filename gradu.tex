...
\title{Systemaattinen kirjallisuuskatsaus junior-ohjelmistokehittäjien / ohjelmistokehittäjätulokkaiden perehdyttämiskäytännöistä ohjelmistokehitysorganisaatioissa (v. 0.2.2)}
...
Tähän systemaattiseen kirjallisuuskatsaukseen valittiin siis yhteensä 20 artikkelia. Artikkelit on esitelty taulukossa x (TODO). 
