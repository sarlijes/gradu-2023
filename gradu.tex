...
\title{Systemaattinen kirjallisuuskatsaus ohjelmistokehitysalan perehdytyskäytännöistä (v. 0.6.1)}
...
\chapter{Laadun arviointi TODO mieti paikka}

Katsauksen artikkeleiden rakennetta arvioitiin käyttämällä kymmenosaista kriteeristöä (\textcite{apa-2001}, \textcite{randolph-ym-2008} mukaan). Siinä arvioidaan artikkeleita sen perusteella, sisältävätkö ne oleelliset elementit, joita American Psychological Association pitää välttämättöminä empiirisissä artikkeleissa, joissa raportoidaan ihmisiin kohdistuvista tutkimuksista. Artikkeliin tulee sisältyä esimerksi tiivistelmä, kirjallisuuskatsaus ja tutkimuskysymysten määrittely (\textcite{apa-2001}, \textcite{randolph-ym-2008} mukaan). Kriteeristöä täydennettiin vielä kahdella kriteerillä (``Rajoitteita arvioitu'' ja ``Tuloksia arvioitu suhteessa aiempaan tutkimukseen''). Taulukossa \ref{tbl:rakenteen-kriteerit} esitellään kukin kriteeri ja tiedot siitä, moniko artikkeli täytti kriteerin (lukumäärä ja prosentuaalinen osuus). Kaikissa artikkeleissa oli tiivistelmä eli abstrakti. Niinikään kaikissa artikkeleissa oli esitelty tutkimuksen tutkimusongelma. Tutkimusympäristöt ja -menettelyt sekä tutkimusten tavoitteet ja niissä käytetyt mittarit oli kuvattu valtaosassa artikkeleista. Rajoitteita arvioitiin 70 prosentissa artikkeleista. Huomionarvioista on se, että tutkimuskysymys nimettiin eksplisiittisesti vain yhdessätoista artikkelissa kahdestakymmenestä. Yhtä monessa artikkelissa oli arvioitu saatuja tuloksia suhteessa aiempaan tutkimukseen.

 %&  & Tiivistelmä mukana & Tutkimusongelma esitellään & Kirjallisuuskatsaus esitellään & Tavoite tai perustelu esitellään & Tutkimuskysymykset tai hypoteesit esitellään & Osallistujat kuvataan asianmukaisesti & Tutkimusympäristö kuvataan asianmukaisesti & Mittaristo kuvataan asianmukaisesti & Menettely kuvataan asianmukaisesti & Tulokset ja pohdinta erotettu toisistaan & Tuloksia arvioitu suhteessa aiempaan tutkimukseen & Rajoitteita arvioitu &  \\
...
\begin{scriptsize}
    ...
    \multicolumn{1}{|c}{} & \multicolumn{16}{| c |}{\textbf{Sosialisaatioresurssiteorian \parencite{saks-gruman-2012} ulottuvuus}} \\
        \hline
            & Tiivistelmä & Tutkimusongelma & Kirjallisuuskatsaus & Tavoite/perustelu & Tutkimuskysymykset & Osallistujat kuvataan & Tutkimusympäristö kuvataan  & Mittaristo kuvataan & Menettely kuvataan  & Tulokset ja pohdinta erikseen & Tuloksia arvioitu suhteessa aiempaan tutkimukseen & Rajoitteita arvioitu & \textbf{14} & \textbf{17} & \textbf{18} & \textbf{19} \\
        \hline
    \endfirsthead
...
\textcite{rodeghero-ym-2021} & x & x & x & x & x & x & x & x & x & x & x & x & x2 \\
\textcite{azanza-ym-2021} & x & x & x & x &   & x & x & x & x & x &   & x & x  \\
\textcite{ju-ym-2021} & x & x & x & x & x & x & x & x & x & x & x & x & x2 \\
\textcite{britto-ym-2020} & x & x & x & x & x & x & x & x & x & x & x & x & x2 \\
\textcite{yates-ym-2020} & x & x & x & x & x & x & x & x & x & x & x & x & x2 \\
\textcite{moe-ym-2020} & x & x & x & x & x & x & x & x & x & x & x & x & x2 \\
\textcite{kumar-wallace-2019} & x & x & x & x &   &   & x & x & x &   & x &   & 8 \\
\textcite{viviani-murphy-2019} & x & x & x & x &   & x & x & x & x & x & x &   & x  \\
\textcite{buchan-ym-2019} & x & x & x & x & x & x & x & x & x & x &   & x & xx \\
\textcite{tuzun-ym-2018} & x & x & x & x &   & x & x & x & x & x &   & x & x  \\
\textcite{matturro-ym-2017} & x & x & x & x & x & x & x & x & x & x & x & x & x2 \\
\textcite{britto-ym-2017} & x & x & x & x & x & x & x & x & x & x & x & x & x2 \\
\textcite{pham-ym-2017} & x & x & x & x & x & x & x & x & x & x & x & x & x2 \\
\textcite{kumar-ym-2016} & x & x & x &   &   &   & x &   & x &   &   &   & 5 \\
\textcite{shannon-pool-2016} & x & x &   &   &   &   & x & x & x & x &   &   & 6 \\
\textcite{viana-ym-2014} & x & x & x & x &   & x & x & x & x & x & x & x & xx \\
\textcite{hemphill-begel-2011} & x & x & x & x &   & x & x & x & x &   &   & x & 9 \\
\textcite{kulkarni-ym-2010} & x & x &   & x & x & x & x & x & x &   &   &   & 8 \\
\textcite{johnson-senges-2010} & x & x & x & x & x & x & x & x & x & x &   & x & xx \\
\textcite{bjornson-dingsøyr-2005} & x & x & x & x &   &   &   &   &   &   &   &   & 4 \\

yhteensä kpl & 20 & 20 & 18 & 18 & 11 & 16 & 19 & 18 & 19 & 15 & 11 & 14 \\
prosentuaalinen osuus & 100 & 100 & 90 & 90 & 55 & 80 & 95 & 90 & 95 & 75 & 55 & 70 \\
