...
Luvussa \ref{luku-tulokkaiden-haasteet} kuvailtiin ohjelmistokehittäjien ensitaipaleellaan kohtaamia haasteita viidellä aihealueella, jotka ovat tiedonhankinta, dokumentaatio, kohdealueen tuntemus, kognitio, ammattiosaaminen ja kommunikointi. Kirjallisuudessa ratkaisuna näihin tehdään kehitysehdotuksia ohjelmistokehittäjiä kouluttaville tahoille %
\parencites%
    {radermacher-ym-2015}%
    {begel-simon-2008}%
    {begel-simon-2008-all-over-again}%
...
\relax.
%
Mielestäni näyttää kuitenkin siltä, monet haasteet liittyvät itse asiassa enemmän työyhteisön rakenteisiin, prosesseihin ja perehdyttämiskäytäntöihin, eivät varsinaisesti vasta-alkajien osaamiseen. Seuraavassa pohditaan, miten tämän kirjallisuuskatsauksen tulokset vastaavat eri aihealueiden haasteisiin ja miten tuloksia voisi hyödyntää ohjelmistokehittäjien perehdyttämisessä.
...
%
. 
Tulokas ei aina havaitse jääneensä jumiin eikä ymmärrä tarvitsevansa apua \parencite{begel-simon-2008}. 

Osa tulokkaista myös jättää  kysymyksiä esittämättä välttääkseen näyttämästä osaamattomuuttaan 
\parencites%
    {radermacher-ym-2015}%
    {begel-simon-2008}%
\relax
%.  
Tässä katsauksessa havaituista perehdytyskäytännöistä erityisesti mentorointiin (ulottuvuus 4) liittyvät käytännöt voisivat auttaa tulokkaita tässä. Myös ulottuvuus 13 (informaatio) korostuu. Työtehtävän kontekstualisointi, joka mainittiin viidessä artikkelissa, voisi auttaa tulokasta samaan jäsennetyn käsityksen tehtävästä. Katsauksen artikkeleista vain yhdessä mainittiin perehdytyskäytäntönä tulokkaalle etukäteen valmisteltu projekti. Tätä voitaisiin hyödyntää erityisesti silloin, jos työyhteisöön liittyy junior-ohjelmistokehittäjä. Selkeärajainen, valmiiksi valmisteltu ja huolellisesti tehtäväksiannettu projekti voisi auttaa tulokasta alkuun ja varmistaa, että työsuhteen alussa turhautuminen olisi vähäistä ja onnistumisen kokemuksia tulisi.

Viidessä katsauksen artikkeleissa mainittiin Good First Issue -käytäntö, eli tulokkaille annettiin työtehtäviä, joiden katsottiin sopivan erityisen hyvin tulokkaille. Kun kirjallisuuden perusteella tiedetään, että tulokkailla on puutteita ammattiosaamisessa, mikä näkyy haasteina versionhallinnan käyttämisessä, ohjelmistotestauksessa, ohjelmistokoodissa navigoimisessa ja ohjelmistokehitystiimissä työskentelyssä %
\parencites%
    {craig-ym-2018}%
    {matturro-ym-2017}%
    {dagenais-ym-2010}%
...
\relax
% 
, olisi hyödyllistä, että ensimmäiset työtehtävät olisivat varsin yksinkertaisia, jotta tulokas pääsee harjoittelemaan näitä taitoja heti aluksi. Kuten \textcite{ju-ym-2021} toteavat, työtehtävien vaikeustason tulisi kuitenkin nousta tulokkaan opittua perusasiat, jossa motivaatio pysyy yllä. 
...
Kehitettävän ohjelmiston kohdealueen tuntemuksen puute vaikeuttaa tulokkaiden työskentelyä %
\parencites%
    {matturro-ym-2017}%
    {dagenais-ym-2010}%
\relax
...
Tässä avuksi voisi tulla ulottuvuuden 9 (työn tekemisen resurssit) ja erityisesti organisaation sisäiseen dokumentaatioon perehtyminen. Kirjallisuuden mukaan tulokkaiden käytettävissä ei kuitenkaan aina ole kattavaa, ajantasaista ja ymmärrettävää dokumentaatiota %
\parencites%
    {matturro-ym-2017}%
    {dagenais-ym-2010}%
    {begel-simon-2008}%
\relax
%
. Miten kohdealueen tuntemusta sitten saataisiin siirrettyä tulokkaille? Katsauksen käytännöistä kyseeseen voisivat tulla ulottuvuuden 3 (oma-aloitteisuuteen kannustaminen) käytännöt kuten aktiivisuuteen kannustaminen ja tulokas haastattelee kokeneita, mutta vastuuta oppimisesta ei voi mielestäni sysätä vain tulokkaalle itselleen. Kun tiedetään, että tulokkaat hyödyntävät mielellään ensin dokumentaatiota ja vasta sitten konsultoivat mentoriaan (VIITE??), olisi dokumentointiin panostaminen tärkeää. Kun lisäksi mentorointi saattaa olla muodostua mentorille itselleen taakaksi, olisi tärkeää että tulokkaat voisivat ensin hyödyntää dokumentaatiota. Sen päivittämiseen kokeneilta työntekijöiltä kuluva aika voi hyvin säästyä siinä, että tulokkaat voivat oppia asioita itse, eikä kysellä niitä jatkuvasti mentorilta.

KESKEN!


Tulokkaiden on omaksuttava paljon tietoa työsuhteensa alussa \parencite{dagenais-ym-2010}. perehdytys vailla jäsennystä.

Kehitettävien ohjelmistojen suurikokoisuus ja monimutkaisuus aiheuttavat myös haasteita tulokkaiden työskentelylle %
\parencites%
    {craig-ym-2018}%
    {britto-ym-2019}%
\relax
...
\section{Tulosten hyödyntämisen mahdollisuudet vanha}
