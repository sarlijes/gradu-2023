...
Miksi tulokkaiden perehdyttäminen on ohjelmistoalalla erityisen haastavaa? Esimerkiksi \textcite{bologa-lupu-2014} toteavat, että kehittyminen juniorista osaajaksi kestää tyypillisesti noin kaksi vuotta. \textcite{britto-ym-2020} taas mainitsevat sen voivan kestää kolmesta jopa viiteen vuotta.

Ohjelmistokehitys on haastavaa ja tietointensiivistä asiantuntijatyötä \parencite{viana-ym-2014}.

Ohjelmistokehityksen perustaitojen kuten ohjelmoinnin, testaamisen ja virheenkorjauksen sekä näihin liittyvien käytäntöjen ja työkalujen lisäksi kehittäjien on osattava laaja joukko muitakin taitoja kuten kyky laatia kattavia vaatimusmäärittelyjä, omaksua nopeasti uusia kohdealueita ja menetelmiä, laatia kattavia vaatimusmäärittelyjä ja kommunikoida tästä kaikesta eri tahoille %
\parencites%
    {tejera-hernández-ym-2018}%
    {begel-simon-2008-all-over-again}%
\relax.
%
\textcite{tejera-hernández-ym-2018} myös huomauttavat, että työssä käytettävien teknologioiden nopea kehitys asettaa myös vaatimuksia työntekijöiden ja organisaatioiden oppimiselle ja kehittymiselle. Ohjelmistokehityksen opiskeleminen antaa vain perustaidot alalla työskentelyyn \parencite{begel-simon-2008-all-over-again}.
