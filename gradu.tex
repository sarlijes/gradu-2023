...
\tiivistelma{Tutkielmassa toteutettiin systemaattinen kirjallisuuskatsaus, jossa tutkittiin ohjelmistokehitysalan perehdytyskäytäntöjä. Katsauksessa tunnistettiin 45 perehdytyskäytäntöä, jotka luokiteltiin sosialisaatioresurssien teorian eri ulottuvuuksiin. Eniten tunnistettiin käytäntöjä, jotka liittyvät mentorointiin, tulokkaille annettaviin työtehtäviin ja palautteen antamiseen. Lisäksi tulokset toivat esiin tulokkaiden keskinäisen oppimisen, joka tutkielmassa määriteltiin sosialisaatioresurssien teoriaa täydentäväksi ulottuvuudeksi. Katsaus täydentää aiempaa tutkimusta, joka on painottunut yhtäältä yksittäisten yritysten perehdyttämiskäytäntöjen tapaustutkimuksiin ja toisaalta avoimen lähdekoodin yhteisöjen käytäntöihin.}
...
TODO metateksti
Tässä uvussa esitellään katsauksen tulokset. Ensin katsaukseen valituista artikkeleista. Sen jälkeen vastataan tutkielman tutkimuskysymykseen perehdytyskäytäntöjä koskevia tuloksia esittelevässä luvussa. Tämän jälkeen esitellään artikkelien tutkimusasetelmia, -menetelmiä ja -kohteita. Lopuksi luodaan pohjaa artikkelien laadun arvioinnille esittelemällä niiden rakenteellisiin piirteisiin liittyviä tuloksia.
...
Tässä luvussa tehdään yhteenvetoa tutkielmassa toteutetusta kirjallisuuskatsauksesta sekä arvioidaan katsausta ja sen validiteettiä eri avoin. Alun yhteenvedon jälkeen arvioidaan katsauksen tuloksiin liittyviä rajoitteita. Seuraavaksi arvioidaan tutkielman teoreettista viitekehystä ja katsauksen tutkimusprotokollaa. Lopuksi arvioidaan tutkielman eettisiä ulottuvuuksia.
