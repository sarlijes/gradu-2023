...
Tulokkaiden on vaikeaa esittää oikeille kollegoille kysymyksiä, joilla he saisivat oikea-aikaista, tilanteeseen sopivasti jäsenneltyä tietoa %
\parencites%
    {ju-ym-2021}%
    {britto-ym-2019}%
    {craig-ym-2018}%
...
% 
. 
Tämän katsauksen tulosten perusteella näihin haasteisiin voisi vastata työn tekemisen resurssien perehdytyskäytännöillä. Erityisesti sisäiseen dokumentaatioon perehtymällä tulokas voisi saada kattavan kuvan työtehtävästään. Myös informaation ulottuvuuteen liittyvät käytännöt kuten olemassa olevan koodin ja sen arkkitehtuurin esittely voisivat auttaa tulokkaita tässä. Myös katsauksessa erityisesti korostunut mentoroinnin ulottuvuus on tärkeä, sillä mentorilta tulokas voi kysyä apua matalalla kynnyksellä 
\parencites%
    {viviani-murphy-2019}%
    {moe-ym-2020}%
\relax.
%
Työtehtävän kontekstualisointi, kuten uuden työtehtävän läpikäyminen kokeneen kollegan kanssa, voisi auttaa tulokasta saamaan jäsennellyn käsityksen työtehtävästä ja auttaa ymmärtämään työtehtävän merkityksen osana kokonaisuutta. Yhteistoiminnallinen ohjelmointi parittain tai ryhmässä voisi tuoda tulokkaalle oikea-aikaista apua. Katsauksen artikkeleista vain yhdessä mainittiin perehdytyskäytäntönä tulokasta varten etukäteen valmisteltu projekti. Tätä voitaisiin hyödyntää laajemmin erityisesti silloin, jos työyhteisöön liittyy junior-ohjelmistokehittäjä. Selkeärajainen, valmiiksi valmisteltu ja huolellisesti tehtäväksiannettu projekti voisi auttaa tulokkaan alkuun ja varmistaa, että työsuhteen alussa turhautuminen olisi vähäistä ja että tulokas saisi onnistumisen kokemuksia. Projektin hyvä dokumentaatio varmistaisi, että tulokas saisi tarvitsemansa tiedon valmiiksi jäsenneltynä.
...
\relax
% 
. Apua olisi varmasti työn tekemisen resurssien ulottuvuuden käytännöistä ja niistä erityisesti organisaation sisäiseen dokumentaatioon perehtymisestä. Kirjallisuuden mukaan tulokkaiden käytettävissä ei kuitenkaan aina ole kattavaa, ajantasaista saati ymmärrettävää dokumentaatiota %
\parencites%
    {matturro-ym-2017}%
    {dagenais-ym-2010}%
    {begel-simon-2008}%
