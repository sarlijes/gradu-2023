...
\section{Tulosten suhde aiempaan tutkimukseen}
\label{luku-tulosten-suhde-aiempaan-tutkimukseen}

\textit{"Joo, mä uskon hyvin että open source communityjen perehdytykset on hyvin erilaisia kuin firmojen, vaikka communityn takana firma olisikin. Ja on ihan ok rajata näin, pitää vaan sanoa että voi vaikuttaa tuloksiin. Lisäksi voisi vertailla että mitä eroja on ja pohdiskella miksi? Koska community jos mikä on yhteisö, johon uudet ihmiset pitää integroida mukaan, ja vielä vaikea sellainen jos kaikki on vapaaehtoisia, kun taas firmassa voi vaan käskeä että tämä kurssi pitää suorittaa."}

Esittele muutamia aiemmin perehdytyskäytäntöjä selvittäneitä tutkimuksia. Pitäisikö ne esitellä jo teoriaosassa, ja täällä palata vertailemaan niiden tuloksia tämän katsauksen tuloksiin? erityisesti OSS vertailua voisi tehdä. 
